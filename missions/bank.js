const bankMission = {
  id: 'bank',
  title: '은행 통장 개설',
  background: 'images/bank_informationdesk.webp',
...
Debit card (체크카드) requires ARC — passport only is not enough.`,
  ...
  images: ['images/bank_informationdesk.webp', 'images/bank_waiting.webp', 'images/bank_counter.webp'],
  sceneFn() {
    const scenes = {};
