const realestateMission = {
  id: 'realestate',
  title: '부동산 — 집 구하기',
  background: 'images/real_estate.webp',
...
중개수수료 (agent commission) applies — typically 300,000–500,000 KRW.`,
  ...
  images: ['images/real_estate.webp', 'images/real_estate_office.webp', 'images/room_visit_A.webp', 'images/room_visit_B.webp'],
  sceneFn() {
    const scenes = {};
    ...
    scenes.visitRoom = () => {
      bg(selectedVisit === 'B' ? 'room_visit_B.webp' : 'room_visit_A.webp');
    ...
    scenes.otherRoom = () => {
      ...
      selectedVisit = other;
      bg(other === 'B' ? 'room_visit_B.webp' : 'room_visit_A.webp');
